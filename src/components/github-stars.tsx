...
export function GithubStars() {
    ...
    async function fetchStars() {
      ...
      try {
        const response = await fetch(
          "https://api.github.com/repos/federicofanini/uara.co"
        );
  ...
  return (
    <div
      className={cn(
        "flex items-center gap-2 transition-opacity duration-300 text-muted-foreground md:text-sm",
